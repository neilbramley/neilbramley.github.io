...
$link = mysql_connect("mysql-server.ucl.ac.uk","ucjtw3g","vXq37JTQc4J22R9uIITd");//"1Ammooi9"
...
UNION (SELECT 'ip' FROM neil_acl2b WHERE neil_acl2b.ip ='$ip_address')
UNION (SELECT 'ip' FROM neil_acl2c WHERE neil_acl2c.ip ='$ip_address')
UNION (SELECT 'ip' FROM neil_acl3 WHERE neil_acl3.ip ='$ip_address')
UNION (SELECT 'ip' FROM neil_acl3_second_run WHERE neil_acl3_second_run.ip ='$ip_address')
UNION (SELECT 'ip' FROM neil_acl3_third_run WHERE neil_acl3_third_run.ip ='$ip_address')";
