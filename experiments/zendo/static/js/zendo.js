...
function TestDevice(e){
    ...
    if (check==true)
    {
		...
		if (buddah_nature==true)
		{
			...
			var b = new BitmapData("static/images/stars.png");
			effect = new Bitmap(b);
...
function DrawHistory(td, bn, phase)
{
    ...
    if (phase!==3)
    {
    	if (bn===true)
	    {
	        var bd  = new BitmapData('static/images/star2.png');//tick.png');

	    } else if (bn===false)
	    {
	        var bd = new BitmapData('static/images/whitestar.png');//cross.png');
	    }
